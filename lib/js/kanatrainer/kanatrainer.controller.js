...
function initiate (area, levels) {
  ...
  $("#kanaResultsButton").click(function(){
    _kanaTrainer.save();
...
function displayHint () {
  ...
  var image = ROOT_DIR+"img/japanese/"+_area+"/"+_kanaHandler.getText(question)+".jpg";
  $(".kana-hint-image").html('<img src="'+image+'" width="200">');
  $(".kana-hint-box").show();
}
...
function saveResults () {
  sessionStorage.setItem(area+"_trainer", JSON.stringify(_kanaTrainer));
}
